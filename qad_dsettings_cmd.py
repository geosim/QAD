...
class QadDSETTINGSDialog(QDialog, QObject, qad_dsettings_ui.Ui_DSettings_Dialog):
   def __init__(self, iface):
      ...
      OsMode = QadVariables.get("OSMODE")
      ...
      self.checkBox_TANP.setChecked(OsMode & QadSnapTypeEnum.TAN)
      self.checkBox_IsOnapON.setChecked(OsMode & QadSnapTypeEnum.DISABLE)
      
      # Inizializzazione della TAB 2 (index 1) che riguarda il puntamento polare
      UserAngle = QadVariables.get("POLARANG")
      ...
      self.checkBox_PolarPickPoint.setChecked(OsMode & QadSnapTypeEnum.POLAR)
      
      ProgrDistance = QadVariables.get("OSPROGRDISTANCE")
   ...
   def ButtonBOX_Accepted(self):
      ...
      QadVariables.set("OSMODE", newOSMODE)
      QadVariables.set("POLARANG", UserAngle)
      SProgrDist = self.lineEdit_ProgrDistance.text()
      ProgrDist = qad_utils.str2float(SProgrDist)
      QadVariables.set("OSPROGRDISTANCE", ProgrDist)
      QadVariables.save()
      self.close()
      return True
